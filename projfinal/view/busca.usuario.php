             ...
             <?php
              foreach ($usuarios as $u1) {
                ...
                <tr>
                  ...
                  <td>".$u1->nascimento."</td>
                  <td>
                  <a class=\"icon\" href=\"../controller/usuario.controller.php?op=editar&id_usuario=$u1->id_usuario\">
                  ...
                  &nbsp;
                  &nbsp;
                  <a class=\"icon\" href=\"../controller/usuario.controller.php?op=excluir&id_usuario=$u1->id_usuario\">
                    <svg class=\"icon\" xmlns='http://www.w3.org/2000/svg' class='ionicon' viewBox='0 0 512 512'>
                      <title>Excluir</title>
